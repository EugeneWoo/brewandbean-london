...
export const coffeeShops: CoffeeShop[] = [
  ...
  {
    id: "generic-multi-site",
    name: "Bean & Brew Co",
    address: "12 High Street, N1 0AA",
    neighborhood: "Angel",
    lat: 51.5320,
    lng: -0.1050,
    ...
    roaster: "Various",
    phone: "+44 20 7226 0000",
    website: "https://example.com",
    instagram: "@beanandbrew",
    isOpen: true,
    hours: { Mon: "7:00–18:00", Tue: "7:00–18:00", Wed: "7:00–18:00", Thu: "7:00–18:00", Fri: "7:00–18:00", Sat: "8:00–17:00", Sun: "9:00–16:00" },
    attributes: { kidsFriendly: true, laptopFriendly: true, sitIn: true, foodMenu: true, opensEarly: true, opensLate: false, specialtyCoffee: false, dogFriendly: true },
    communityReview: "A growing local chain with decent coffee but nothing exceptional. Expanding quickly across North London.",
    sentimentTags: ["Convenient", "Multi-location"],
    nearestTransport: ["Angel (3 min)"],
    verification: { totalLocations: 12, googleRating: 4.1, hasFullInfo: true },
  },
];
